...
public interface GetStepApi {
    ...
    @ApiOperation(value = "Get one enigma step API", nickname = "getStep", notes = "Get one enigma step API", response = JsonApiBodyResponseSuccess.class, responseContainer = "List", tags={ "get-one-enigma-step-api-controller", })
    @ApiResponses(value = {
